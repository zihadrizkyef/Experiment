...
//          port.writePort(dummy, 0, dummy.length);
            ...
            if (status.offline) {
                throw new StarIOPortException("Star " + portName + " is offline");
            }
            ...
            if (status.coverOpen) {
                throw new StarIOPortException("Star " + portName + " cover is open");
            }
            else if (status.receiptPaperEmpty) {
                throw new StarIOPortException("Star " + portName + ", receipt paper is empty");
            }
            else if (status.offline) {
                throw new StarIOPortException("Star " + portName + " is offline");
            }
            ...
            // Nothing
            Timber.d("StarIOPortException " + e.getMessage() + " " + e.getStackTrace());
        }
        finally {
            if (port != null) {
                try {
