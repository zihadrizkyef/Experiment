...
public class KassenApiHelper {

    private static final String TAG = "KassenApiHelper";
    public static final String POS_SERVICE = "posmanager";

    private ICiontekPosService mPosService;
    private static KassenApiHelper mInstance;

    private KassenApiHelper() {
        try {
    ...
    public static KassenApiHelper getInstance() {
        if (null == mInstance) {
            mInstance = new KassenApiHelper();
        }
        return mInstance;
    }
