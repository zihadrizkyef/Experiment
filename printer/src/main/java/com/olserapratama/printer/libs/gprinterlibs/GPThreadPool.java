...
public class GPThreadPool {
	...
	private static GPThreadPool threadPool;
	/**
	 * java线程池
	 */
	...
	private ThreadFactory threadFactory = new GPThreadFactoryBuilder("ThreadPool");

	private GPThreadPool() {
	...
	public static GPThreadPool getInstantiation() {
		if (threadPool == null) {
			threadPool = new GPThreadPool();
		}
		return threadPool;
	}
